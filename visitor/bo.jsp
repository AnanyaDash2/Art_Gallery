...
<h1>Bought Artworks</h1>

<%
    String error = null;
    HttpSession session1 = request.getSession();
    // Retrieve customer details from session1
    ...
    try {
        ...
        // Retrieve artworks purchased by the current customer
        String selectQuery = "SELECT id, art_name, art_type, artist_name, cost FROM art WHERE customer_id = ?";
...
<table>
    ...
    <tbody>
        ...
        <% if (!hasData) { %>
            <tr>
                <td colspan="4" style="text-align:center;">No artworks purchased yet.</td>
            </tr>
        <% } %>
    </tbody>
</table>
