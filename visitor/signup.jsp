...
<head>
    ...
    <title>Visitor Signup - Art Gallery Management</title>
    <style>
        * {
            margin: 0;
            padding: 0;
            ...
            if (request.getMethod().equalsIgnoreCase("POST")) {
                ...
                if (!phone_number.matches("\\d{10}")) {
                    ...
                    try {
                        ...
                        String checkUserQuery = "SELECT * FROM customer WHERE username = ? OR email = ?";
                        ...
                        if (rs.next()) {
                            ...
                            String query = "INSERT INTO customer (name, email, username, password, phone_number) VALUES (?, ?, ?, ?, ?)";
